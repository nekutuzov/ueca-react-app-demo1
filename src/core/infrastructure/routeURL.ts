...
// Route → URL resolution, kept out of AppBrowsingHistory so navigation and a link's href resolve
// through the same rules. That model supplies its own base URL.
//
...
//   "/users/12"                   app-relative  → the ONLY form the base is prepended to
//
